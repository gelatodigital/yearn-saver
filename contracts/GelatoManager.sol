...
// Gelato Dependencies
import { IGelatoCore, Provider, Task, Action, Operation } from "@gelatonetwork/core/contracts/gelato_core/interfaces/IGelatoCore.sol";
import { IGelatoProviders, TaskSpec } from "@gelatonetwork/core/contracts/gelato_core/interfaces/IGelatoProviders.sol";
...
contract GelatoManager {
        ...
        payable
    {
        ...
        // Governance will evantually be set to Yearn Governance Contract when everything works smoothly
